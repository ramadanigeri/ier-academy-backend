  ...
  try {
    ...
    const result = await pool.query(
      `INSERT INTO testimonials 
       (name, position, company, content, photo_url, rating, is_published, sort_order)
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
       RETURNING *`,
      [
        name,
...
router.put("/testimonials/:id", async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE testimonials 
       SET name = $1, position = $2, company = $3, content = $4, photo_url = $5,
           rating = $6, is_published = $7, sort_order = $8, updated_at = NOW()
       WHERE id = $9
       RETURNING *`,
      [
        name,
